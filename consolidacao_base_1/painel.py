...
from consolidacao_base_1.processos import desligar_watcher, ligar_watcher, watcher_ligado
from consolidacao_base_1.watcher import HOSTNAME_PERMITIDO, PASTA_PADRAO, hostname_ok


def abrir_painel() -> None:
    raiz = tk.Tk()
    raiz.title("Consolidação base_1")
