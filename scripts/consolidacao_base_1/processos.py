...
MARCA_WATCHER = "consolidacao_base_1.watcher"
...
def eh_processo_a_controlar(command_line: str | None, pid: int, meu_pid: int) -> bool:
    ...
    return "-m consolidacao_base_1" in compacto and MARCA_WATCHER not in compacto
...
def ligar_watcher() -> None:
    ...
    subprocess.Popen(
        [pythonw_path(), "-m", "consolidacao_base_1.watcher"],
